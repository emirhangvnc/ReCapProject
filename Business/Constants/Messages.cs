...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string CarTypeDetailAdded = "Araba Tipi Eklendi";
        public static string CarTypeDetailDeleted = "Araba Silindi";
        public static string CarTypeDetailUpdated = "Araba Tip Bilgiler Güncellendi";
        public static string CarTypeDetailListed = "Araba Tipleri Listelendi";

        public static string CategoryAdded = "Model Eklendi";
        public static string CategoryDeleted = "Categori Silindi";
        public static string CategoryUpdated = "Categori Güncellendi";
        public static string CategoriesListed= "Categoriler Listelendi";
        ...
        public static string GenderAdded = "Cinsiyet Eklendi";
        public static string GenderDeleted = "Cinsiyet Silindi";
        public static string GenderUpdated = "Cinsiyet Güncellendi";
        public static string GendersListed= "Cinsiyetler Listelendi";
        ...
        public static string RentalUpdated = "Kiralama İşlem Bilgileri Güncellendi";
        public static string RentalListed = "Kiralama İşlemleri Listelendi";

        public static string UserAdded="Üye Eklendi";
        public static string UserDeleted = "Üye Kayıdı Silindi";
        public static string UserUpdated= "Üye Güncellendi";
